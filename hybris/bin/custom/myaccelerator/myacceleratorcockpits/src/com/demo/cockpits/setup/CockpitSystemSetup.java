 ...
 */
package com.demo.cockpits.setup;
...
import com.demo.cockpits.constants.MyacceleratorCockpitsConstants;
 ...
 */
@SystemSetup(extension = MyacceleratorCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MyacceleratorCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MyacceleratorCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MyacceleratorCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/myacceleratorcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
