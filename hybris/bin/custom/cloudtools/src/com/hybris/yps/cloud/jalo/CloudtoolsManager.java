 ...
 */
package com.hybris.yps.cloud.jalo;
...
/**
 * This is the extension manager of the Cloudtools extension.
 */
public class CloudtoolsManager extends GeneratedCloudtoolsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CloudtoolsManager.class);
	 ...
	 */
	public static CloudtoolsManager getInstance()
	{
		return (CloudtoolsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CloudtoolsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CloudtoolsManager() // NOPMD 
	{
		LOG.debug("constructor of CloudtoolsManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CloudtoolsManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CloudtoolsManager called, current tenant: {}", getTenant().getTenantID());
	}
